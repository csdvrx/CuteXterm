...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,     XK_t, spawn,       { 0 } },
        ...
        // csdvrx : apt install libx11-dev libxft-dev to apply:
        // Use PageUp/Down instead of vi keys
	...
	{ MODKEY,               XK_0,      move,        { .i = 9 } },
        ...
        // Shift Ctrl Q to avoid accidental kills
	{ MODKEY|ShiftMask,     XK_q,      killclient,  { 0 } },

        // Likewise, so disable the toggle
